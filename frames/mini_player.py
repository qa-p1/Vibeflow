...
class BasePlayer(QWidget):
    """Base class containing common functionality for both MiniPlayer and MicroPlayer"""
    ...
    def create_control_buttons(self, prev_size=20, play_size=25, next_size=20):
        """Create common control buttons with specified sizes"""
        self.prev_button = create_button('icons/previous.png', self.prev_song, prev_size)
        self.play_button = create_button('icons/play.png', self.play_pause, play_size)
        self.next_button = create_button('icons/next.png', self.next_song, next_size)
...
class MicroPlayer(BasePlayer):
    ...
    def setup_ui(self):
        ...
        self.create_control_buttons(20, 25, 20)
    ...
    def keyPressEvent(self, event):
        if self.handle_common_keys(event):
            event.accept()
            return
...
class MiniPlayer(BasePlayer):
    ...
    def setup_ui(self):
        ...
        self.create_control_buttons(40, 50, 40)
    ...
    def update_shuffle_button_icon(self):
        ...
        if self.main_window.play_mode == "shuffle":
            ...
            self.shuffle_button.setIcon(QIcon("icons/repeat-one.png"))
            self.shuffle_button.setToolTip("Repeat One: ON")
        else:
            self.shuffle_button.setIcon(QIcon("icons/repeat.png"))
